				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<motion.a
								href="mailto:shantanavkapse73@gmail.com"
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								<motion.a
									href="https://github.com/shantanavKapse"
									target="_blank"
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@shantanavKapse</p>
									</div>
								</motion.a>
								<motion.a
									href="https://www.linkedin.com/in/shantanav-kapse/"
									target="_blank"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@shantanav-kapse</p>
									</div>
								</motion.a>
							</div>
						</div>
